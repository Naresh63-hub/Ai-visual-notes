...
import com.visualnotes.security.JwtAuthFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/notes/analyze").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/notes/plan").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/notes/generate").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/notes/public/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/notes/{id}").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/notes/{id}/download/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/notes").authenticated()
                        .requestMatchers(HttpMethod.POST, "/api/notes/{id}/regenerate-page").authenticated()
                        .requestMatchers(HttpMethod.PUT, "/api/notes/{id}/update-page").authenticated()
                        .requestMatchers(HttpMethod.PATCH, "/api/notes/{id}/rename").authenticated()
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(origins.isEmpty() ? List.of("http://localhost:3000", "http://localhost:3001", "http://localhost:5173") : origins);
